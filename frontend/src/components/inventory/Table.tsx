...
export function TableContainer({
  ...
  emptyDescription = 'There are no inventory items to display. Add a new item to get started.',
...
export function SearchInput({ value, onChange, placeholder = 'Search inventory...', className = '' }: SearchInputProps) {
  return (
