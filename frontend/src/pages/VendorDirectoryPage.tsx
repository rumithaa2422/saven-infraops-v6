        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-2xl font-bold text-white truncate">Vendor Directory</h1>
              <p className="text-sm text-white/80 mt-1">Manage vendor relationships and contracts</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {isAdmin && (
              <>
                ...
                <button type="button" className="px-5 py-2.5 rounded-xl bg-white text-purple-600 font-bold hover:bg-white/90 transition-all duration-200 shadow-lg shadow-purple-500/30 flex items-center gap-2 text-sm" onClick={() => setShowCreateDialog(true)}>
