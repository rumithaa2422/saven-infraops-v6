  ...
  return (
    <div className="detail-page">
      ...
      <div className="detail-summary-cards">
        ...
        <div className="detail-summary-card">
          <span className="detail-summary-label">Sub Category</span>
          <span className="detail-summary-value">{asset.subcategory?.name || '-'}</span>
        </div>
        <div className="detail-summary-card">
        ...
        <div className="detail-summary-card">
          <span className="detail-summary-label">Assigned To</span>
          <span className="detail-summary-value">{asset.assignedToName || '-'}</span>
        </div>
        <div className="detail-summary-card">
          <span className="detail-summary-label">Warranty Status</span>
          <span className={`detail-summary-value ${warrantyStatus.class}`}>
        ...
        <div className="detail-card">
          <div className="detail-grid">
            ...
            <div className="detail-field">
              ...
              <span className={`detail-warranty-status ${warrantyStatus.class}`}>
                {warrantyStatus.label}
              </span>
            </div>
          </div>
