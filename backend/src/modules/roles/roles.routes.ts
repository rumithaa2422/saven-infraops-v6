...
// Get all permissions
rolesRouter.get('/permissions', requireAuth, async (_req, res, next) => {
  try {
...
rolesRouter.get('/:id', requireAuth, async (req, res, next) => {
  try {
...
rolesRouter.patch('/:id/permissions', requireAuth, async (req, res, next) => {
  try {
